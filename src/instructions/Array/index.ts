...
const selectionSortInstruction = (data: number[], _params: Array.SortParams) => {
...
const bubbleSortInstruction = (data: number[], _params: Array.SortParams) => {
  let instructions = new Instructions();
...
const insertionSortInstruction = (data: number[], _params: Array.SortParams) => {
  let instructions = new Instructions();
  instructions.setDuration(750);
  let array = initArray(data);
