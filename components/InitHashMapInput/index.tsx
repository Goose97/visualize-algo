...
export class InitHashMapInput extends Component<PropsWithHoc, IState> {
  ...
  handleChange = (value: ReactText) => {
    const {
      value: hashMapValue,
      error,
    } = this.getHashMapRepresentationFromInputText(value.toString());
    this.setState({ input: hashMapValue, error });
  };

  getHashMapRepresentationFromInputText(
    inputText: string,
...
export default withExtendClassName('f-big-2 px-6 py-2')(InitHashMapInput);
